...
int main()
{
    eMarca marca[TAMMARCA] = {{1001, "Compaq"}, {1002, "Asus"}, {1003, "Acer"}, {1004, "HP"}}; // HARDCODEO MARCA
    eTipo tipo[TAMTIPO] = {{5001, "Gamer"},{5002, "Disenio"},{5003, "Ultrabook"}, {5004, "Normalita"}}; // HARDCODEO TIPO
    eServicio servicio[TAMSER] = {{20001, "Bateria", 250}, {20002, "Antivirus", 300}, {20003, "Actualizacion", 400}, {20004, "Fuente", 600}}; // HARDCODEO SERVICIO
    eNotebook notebook[TAM]; // CREO EL ARRAY DE LA ESTRUCTURA NOTEBOOK
    inicializarNotebooks(notebook, TAM); // INICIALIZA EL ARRAY NOTEBOOK, IGUALA A 0 LA LLAVE PARA HABILITAR CADA ESTRUCTURA
    hardcodearNotebooks(notebook); // HARDCODEA 10 NOTEBOOKS
    eTrabajo trabajo[TAMTRAB]; // CREO EL ARRAY PRINCIPAL DE LA ESTRUCTURA TRABAJO
    inicializarTrabajos(trabajo, TAMTRAB); // INICIALIZA EL ARRAY TRABAJO, IGUALA A 0 LA LLAVE PARA HABILITAR CADA ESTRUCTURA
    hardcodearTrabajos(trabajo); // HARDCODEO 10 TRABAJOS
